...
gs_plugins_core_generic_updates_func (GsPluginLoader *plugin_loader)
{
	...
	g_assert_cmpstr (gs_app_get_id (os_update), ==, "org.ubuntuunity.software.OsUpdate");
...
main (int argc, char **argv)
{
	...
	tmp_root = g_dir_make_tmp ("unity-software-core-test-XXXXXX", NULL);
	...
	g_test_add_data_func ("/unity-software/plugins/core/search-repo-name",
			      plugin_loader,
			      (GTestDataFunc) gs_plugins_core_search_repo_name_func);
	g_test_add_data_func ("/unity-software/plugins/core/os-release",
			      plugin_loader,
			      (GTestDataFunc) gs_plugins_core_os_release_func);
	g_test_add_data_func ("/unity-software/plugins/core/generic-updates",
			      plugin_loader,
