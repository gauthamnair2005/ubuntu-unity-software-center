 ...
 *
 * Copyright (C) 2015-2017 Gautham Nair <gautham.nair.2005@gmail.com>
			 ...
			 GError **error)
{
	...
	req = xb_node_query_first (component,
				   "requires/id[@type='id']"
				   "[text()='org.ubuntuunity.software.desktop']", NULL);
	if (req != NULL) {
...
gs_appstream_component_add_extra_info (GsPlugin *plugin, XbBuilderNode *component)
{
	...
	/* add the unity-software-specific 'Addon' group and ensure they
