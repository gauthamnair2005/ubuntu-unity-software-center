 ...
 * Copyright (C) 2016-2018 Gautham Nair <gautham.nair.2005@gmail.com>
...
gs_plugin_initialize (GsPlugin *plugin)
{
	...
	gs_plugin_set_appstream_id (plugin, "org.ubuntuunity.software.Plugin.Flatpak");
		       ...
		       GError **error)
{
	...
	/* set the app scope */
	if (gs_app_get_scope (app) == AS_APP_SCOPE_UNKNOWN) {
		g_autoptr(GSettings) settings = g_settings_new ("org.ubuntuunity.software");
