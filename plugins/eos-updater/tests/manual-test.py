...
class ManualTest(dbusmock.DBusTestCase):
    '''A manual test of the eos-updater plugin in unity-software.

    It creates a mock eos-updater D-Bus daemon, on the real system bus (because
    otherwise unity-software’s other plugins can’t communicate with their
    system daemons; to fix this, we’d need to mock those up too). The test
    harness provides the user with instructions about how to run unity-software
    ...
    cancellation of the daemon from unity-software; and the daemon unexpectedly
    ...
    def setUp(self):
        ...
        # unity-software needs to access various other services (such as
    ...
    def launch_gnome_software(self):
        '''Instruct the user to launch unity-software'''
        print('Launch unity-software with:')
        print('unity-software --verbose')
        self.manual_check('Press enter to continue')

    def kill_gnome_software(self):
        '''Instruct the user to kill unity-software'''
        print('Kill unity-software with:')
        print('pkill unity-software')
        self.manual_check('Press enter to continue')
    ...
    def test_poll_eos_updater_dies(self):
        '''Test that unity-software recovers if eos-updater dies while
        polling for updates.'''
        self.dbusmock.SetPollAction(
            'update', dbus.Dictionary({}, signature='sv'), '', '')
