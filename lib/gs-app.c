 ...
 *
 * Copyright (C) 2013-2016 Gautham Nair <gautham.nair.2005@gmail.com>
 ...
 * a #GsApp in different parts of unity-software can be observed by connecting to
 ...
 * @app: a #GsApp
 * @developer_name: The developer name, e.g. "Gautham Nair"
 *
...
/**
 * gs_app_new:
 * @id: an application ID, or %NULL, e.g. "org.ubuntuunity.software.desktop"
 *
 ...
 *	`system/flatpak/gnome/desktop/org.ubuntuunity.software.desktop/master`
 *
