 ...
 *
 * Returns: a string, e.g. `org.ubuntuunity.software.Plugin.Epiphany`
 *
 * Since: 3.24
 **/
const gchar *
 ...
 * @plugin: a #GsPlugin
 * @appstream_id: an appstream ID, e.g. `org.ubuntuunity.software.Plugin.Epiphany`
 *
 ...
 * If depsolving fails then unity-software will not start.
 *
 * Since: 3.22
 **/
void
