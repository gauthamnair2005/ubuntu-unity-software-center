...
gs_plugin_download_rewrite_func (void)
{
	...
	const gchar *resource = "background:\n"
				" url('file://" DATADIR "/unity-software/featured-maps.png')\n"
				" url('file://" DATADIR "/unity-software/featured-maps-bg.png')\n"
				" bottom center / contain no-repeat;\n";

	/* only when installed */
	if (!g_file_test (DATADIR "/unity-software/featured-maps.png", G_FILE_TEST_EXISTS)) {
...
gs_app_unique_id_func (void)
{
	...
	unique_id = "system/flatpak/gnome/desktop/org.ubuntuunity.software.desktop/master";
	...
	g_assert_cmpstr (gs_app_get_id (app), ==, "org.ubuntuunity.software.desktop");
...
gs_app_func (void)
{
	...
	app = gs_app_new ("unity-software.desktop");
	g_assert (GS_IS_APP (app));
	g_assert_cmpstr (gs_app_get_id (app), ==, "unity-software.desktop");
...
main (int argc, char **argv)
{
	...
	/* tests go here */
	g_test_add_func ("/unity-software/lib/utils{url}", gs_utils_url_func);
	g_test_add_func ("/unity-software/lib/utils{wilson}", gs_utils_wilson_func);
	g_test_add_func ("/unity-software/lib/utils{error}", gs_utils_error_func);
	g_test_add_func ("/unity-software/lib/utils{cache}", gs_utils_cache_func);
	g_test_add_func ("/unity-software/lib/utils{append-kv}", gs_utils_append_kv_func);
	g_test_add_func ("/unity-software/lib/utils{parse-evr}", gs_utils_parse_evr_func);
	g_test_add_func ("/unity-software/lib/os-release", gs_os_release_func);
	g_test_add_func ("/unity-software/lib/app", gs_app_func);
	g_test_add_func ("/unity-software/lib/app/progress-clamping", gs_app_progress_clamping_func);
	g_test_add_func ("/unity-software/lib/app{addons}", gs_app_addons_func);
	g_test_add_func ("/unity-software/lib/app{unique-id}", gs_app_unique_id_func);
	g_test_add_func ("/unity-software/lib/app{thread}", gs_app_thread_func);
	g_test_add_func ("/unity-software/lib/app{list}", gs_app_list_func);
	g_test_add_func ("/unity-software/lib/app{list-wildcard-dedupe}", gs_app_list_wildcard_dedupe_func);
	g_test_add_func ("/unity-software/lib/app{list-performance}", gs_app_list_performance_func);
	g_test_add_func ("/unity-software/lib/app{list-related}", gs_app_list_related_func);
	g_test_add_func ("/unity-software/lib/plugin", gs_plugin_func);
	g_test_add_func ("/unity-software/lib/plugin{download-rewrite}", gs_plugin_download_rewrite_func);
